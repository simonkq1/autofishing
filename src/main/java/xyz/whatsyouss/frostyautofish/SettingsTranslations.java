...
final class SettingsTranslations {
    private static final Map<Key, String> ENGLISH = entries(
            ...
            "Weapon Slot", "Select the hotbar slot used for Auto Kill and High Value ranged abilities.",
            ...
            "Ability Delay", "Auto Kill delay; High Value waits this long before each ranged ability attempt.",
            ...
            "High Value Ranged Attack", "Use Ability must be on: use Weapon Slot within 32 blocks with clear sight. No bows or melee fallback.",
            "High Value Hits", "Maximum melee or ability attempts per tracked target, not confirmed hits.",
    ...
    private static final Map<Key, String> TRADITIONAL_CHINESE = entries(
            ...
            "武器欄位", "選擇自動擊殺與高價值遠距技能使用的快捷欄。",
            "使用技能", "攻擊前使用所選武器的技能。",
            "技能瞄準", "選擇使用技能時鏡頭瞄準的位置。",
            "技能延遲", "自動擊殺的延遲；高價值遠距技能每次使用前等待此時間。",
            ...
            "高價值遠距攻擊", "需開啟使用技能：於 32 格內視線無阻擋時使用武器欄位，不支援弓或回退近戰。",
            "高價值攻擊次數", "每個追蹤目標共用的近戰或技能嘗試上限，不代表確認命中。",
    ...
    enum Key {
        ...
        HIGH_VALUE_RANGED_ATTACK, HIGH_VALUE_RANGED_ATTACK_DESCRIPTION,
